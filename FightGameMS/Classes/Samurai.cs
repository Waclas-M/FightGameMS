...
namespace FightGameMS.Classes
{
    public class Samurai : Hero
    {
        ...
        public Samurai(HeroTemplate template) : base(template.Name, template.ClassName, template.MaxHealth, template.HitBoxWidth, template.HitBoxHeight,
            template.AttackDamage, template.AttackRange, template.SpeedMs)
        {
            ...
            MoveAnimation = new MoveAnimation(Template.ClassName, AnimationsType.WALK, 1000);
